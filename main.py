...
def main():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="/home/hp/anaconda3/envs/FYQtest/project/DepthNet/checkpoint2/", help="The path to the checkpoint directory")
    parser.add_argument("--continue_train", type=bool, default=True, help="Continue train")
    parser.add_argument("--restore_path", type=str, default="/home/hp/anaconda3/envs/FYQtest/project/DepthNet/checkpoint2/", help="The path to load checkpoint")
    ...
    parser.add_argument("--summary_freq", type=int, default=50, help="The frequence to summarize and save model")
    parser.add_argument("--eval_freq", type=int, default=500, help="The frequence to evaluate model")
    parser.add_argument("--save_latest_freq", type=int, default=1000, help="The frequence to save model")
